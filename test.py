...
# # Kapatma zamanını ayarla
# start_time = time.time()

# # İlk başta kapatma işlevini devre dışı bırak
# root.protocol("WM_DELETE_WINDOW", lambda: print("Kapatma işlemi şu anda devre dışı."))

# # Kapatma işlevini arka plan görevleri tamamlandığında güncelle
# def check_tasks_and_set_close_protocol():
#     if background_tasks_done:
#         root.protocol("WM_DELETE_WINDOW", on_closing)
#     else:
#         root.after(1000, check_tasks_and_set_close_protocol)  # Her saniye kontrol et

# # Kontrol fonksiyonunu başlat
# check_tasks_and_set_close_protocol()
